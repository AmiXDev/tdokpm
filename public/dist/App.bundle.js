...
socket.on('chat message', function (data) {
	...
	if (data.isAdmin) var $usernameDiv = $('<span class="username"/>').text("پشتیبان");else var $usernameDiv = $('<span class="username"/>').text("مشتری");
...
socket.on('New Client', function (data) {
	...
	for (var i = len - 1; i >= 0; i--) {
		if (data["history"][i]["who"]) sender = "شما :";else sender = "کاربر :";
	...
	if (!data.justJoined) {
		$newUser.play();
		notifyAdmin("New Client", "سلام و درود به شما" + data.details[0] + " سوالی براتون پیش اومده؟");
...
socket.on('typing', function (data) {
	...
	if (data.isTyping) $typing.append("<small>" + data.person + " در حال نوشتن میباشد.....<small>");else $typing.text('');
});
...
socket.on('reconnect', function () {
	...
	$errorPage.fadeOut();
	$userList.append('<li id=' + username + '>' + username + '</li>');
	if (authenticated) socket.emit('add admin', {
		admin: username,
		isAdmin: true
	});
});
...
socket.on('reconnect_failed', function () {
	...
	$errorMsg.text("اتصال اینترنت شما قطع شد لطفا صفحه را مجدداََ باز کنید.");
	$window.alert("قطع اتصال شما از چت؟");
});
...
function sendMessage(id) {
	...
	if (message && connected) {
		...
		var $usernameDiv = $('<span class="username"/>').text("شما");
...
function getChatArea(id) {
	return "<div class='chatArea'><div class='chatHeader'></div><ul class='messages'>" + "</ul><div class='typing'></div><input class='inputMessage' id='" + id + "'' placeholder='پیام خود را اینجا وارد کنید.'/></div>";
}
...
throw new Error("Module build failed: ModuleBuildError: Module build failed: \n@import 'partials/layout';\n^\n      File to import not found or unreadable: /Volumes/Drive/github/tdokpm/public/sass/partials/_layout.scss.\n      in /Volumes/Drive/github/tdokpm/public/sass/style.scss (line 2, column 1)\n    at /Volumes/Drive/github/tdokpm/node_modules/webpack/lib/NormalModule.js:192:19\n    at /Volumes/Drive/github/tdokpm/node_modules/loader-runner/lib/LoaderRunner.js:367:11\n    at /Volumes/Drive/github/tdokpm/node_modules/loader-runner/lib/LoaderRunner.js:233:18\n    at context.callback (/Volumes/Drive/github/tdokpm/node_modules/loader-runner/lib/LoaderRunner.js:111:13)\n    at Object.callback (/Volumes/Drive/github/tdokpm/node_modules/sass-loader/lib/loader.js:57:13)\n    at Object.<anonymous> (/Volumes/Drive/github/tdokpm/node_modules/sass-loader/node_modules/async/dist/async.js:2271:31)\n    at Object.callback (/Volumes/Drive/github/tdokpm/node_modules/sass-loader/node_modules/async/dist/async.js:969:16)\n    at options.error (/Volumes/Drive/github/tdokpm/node_modules/node-sass/lib/index.js:294:32)");
...
var _slideout = __webpack_require__(2);
...
window.jQuery = _jquery2.default;window.$ = _jquery2.default;
...
var translatedBottomNavbar = document.querySelector('.navbar-bottom-container');
...
var translatedBottomNavbarBLog = document.querySelector('.navbar-bottom-container');
...
var $messages = (0, _jquery2.default)('.messages'); //Message area
var $inputMessage = (0, _jquery2.default)('.inputMessage'); //Text area to input msg
var $nameInput = (0, _jquery2.default)('.nameInput'); //Name input
var $phoneInput = (0, _jquery2.default)('.phoneInput'); //Phone number input
var $emailInput = (0, _jquery2.default)('.emailInput'); //Email input
var $form = (0, _jquery2.default)('.formArea'); // Details form
var $widgetBox = (0, _jquery2.default)('.contentArea'); //Widget box
var $Input = (0, _jquery2.default)('.inputFields'); //Input fields in form
var $chatBox = (0, _jquery2.default)('.chatArea'); //Chat page after filling form
var $Typing = (0, _jquery2.default)(".typing"); //Typing notification
var $newMsg = (0, _jquery2.default)('.msg_push_new'); //Dummy to push new msgs
var $oldMsg = (0, _jquery2.default)('.msg_push_old'); //Dummy to push msg history 
...
(0, _jquery2.default)('.msg_head').click(function () {
...
socket.on('chat message', function (data) {
	var sender;
	if (data.isAdmin) sender = "msg_a";else sender = "msg_b";
	var $messageBodyDiv = (0, _jquery2.default)('<div class="' + sender + '">' + data.msg + '<span class="timestamp">' + data.timestamp.toLocaleString().substr(15, 6) + '</span></div>').insertBefore($newMsg);
	$messages[0].scrollTop = $messages[0].scrollHeight;
});

socket.on('typing', function (data) {
	if (data.isTyping && data.person != 'Client') $Typing.append("پشتیبان در حال نوشتن میباشد....");else $Typing.text('');
});
...
socket.on('log message', function (text) {
	var time = "" + new Date();
	var $messageDiv = (0, _jquery2.default)('<div class="msg_a"><span class="admin"></span>' + text + '<span class="timestamp">' + time.toLocaleString().substr(15, 6) + '</span></div>').insertBefore($newMsg);
	$messages[0].scrollTop = $messages[0].scrollHeight;
});
...
socket.on('reconnect', function () {
	setTimeout(function () {
		...
		if (active && id) socket.emit('add user', {
			isNewUser: false,
			roomID: id
		});
	}, 4000);
...
function sendMessage() {
	...
	if (message) {
		...
		var $messageBodyDiv = (0, _jquery2.default)('<div class="msg_b">' + message + '<span class="timestamp">' + time.toLocaleString().substr(15, 6) + '</span></div>').insertBefore($newMsg);
		$messages[0].scrollTop = $messages[0].scrollHeight;
	}
}
...
function addMessages(data, getMore) {
	var sender;
	if (data["who"]) sender = "msg_a";else sender = "msg_b";
	var $messageBodyDiv = (0, _jquery2.default)('<div class="' + sender + '"><span class="admin"></span>' + data["what"] + '<span class="timestamp">' + data["when"].toLocaleString().substr(15, 6) + '</span></div>');
	if (getMore) {
...
// Prevents input from having injected markup
function cleanInput(input) {
	return (0, _jquery2.default)('<div/>').text(input).text();
}

// minimize support tab

var minimizeIcon = document.querySelector('.minimize-chat-support');
